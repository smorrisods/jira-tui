...
//! `field_mapping`, `history`, `links`, `mouse`, `onboarding`, `query`,
//! `quick_view`, `search`, `sort_filter`, `view_switch`), plus a `transitions`
//! file for the workflow-transition tests. `support` carries the shared
